...
/*
  AddToHomeScreen
  ----------------
  1. Gives the saved home-screen shortcut the standard NaloHub icon (same for
...
export default function AddToHomeScreen({ building }) {
  ...
  useEffect(() => {
    ...
    // Standard NaloHub icon for every user & building — instant recognition.
    upsertLink("apple-touch-icon").setAttribute("href", "/icon-180.png");
    upsertLink("icon").setAttribute("href", "/icon-192.png");
  ...
  const IconPreview = () => (
    <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "2px 0 14px" }}>
      <img src="/icon-192.png" alt="" style={{ width: 52, height: 52, borderRadius: 12, objectFit: "cover" }} />
      <div>
