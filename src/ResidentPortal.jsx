...
const PLATFORM = { name: "Resident Portal", version: "0.10.0" }; // 0.10.0: Word + Excel exports, in-app message import to disputes, Nalo plain-English answers, inbound email capture
