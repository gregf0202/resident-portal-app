...
const PLATFORM = { name: "Resident Portal", version: "0.19.0" }; // 0.13.0: Alerts centre, BCC auto-vote for applications, motion Q&A + attachments, trade/category dropdowns, contract upload, walk-through photos + Word export + editable checklist, Unit Search owners/tenant/agent + legacy fob link
...
function Dashboard() {
  ...
  return (
    <div>
      ...
      {!isStrata(user.role) && <div className="max-w-4xl mx-auto px-5 sm:px-8 -mt-10 relative z-10"><CommitteePlaybook /></div>}
      <Wrap>
        <Weather />
  ...
  return (
    <Card style={{ padding: 16 }}>
      ...
      {!edit && (hc.unit.agent_business
        ...
        : <div className="text-sm" style={{ color: T.textMuted }}>Tenanted unit — no managing agent recorded yet.</div>)}
      ...
      <div className="px-5 pt-4 pb-3" style={{ background: `linear-gradient(135deg, ${hexToRgba(T.accent, 0.14)}, ${hexToRgba(T.accent2, 0.08)})` }}>
        <div className="flex items-center gap-3">
          <div className="flex-1">
            ...
            <div className="text-xs mt-0.5" style={{ color: T.textMuted }}>{complete ? c2 : `${h2} ${n} of ${ITEMS.length} done.`}</div>
          </div>
...
function VotingLive() {
  ...
  const [loading, setLoading] = useState(true);
  const [nf, setNf] = useState({ title: "", description: "" });
  ...
  const open = async () => {
    ...
    try { await createMotion(buildingId, uid, { title: nf.title.trim(), description: nf.description.trim() }); setNf({ title: "", description: "" }); setShowNew(false); flash("Motion opened — every BCC member has been alerted"); reload(); }
    catch (e) { flash(String(e.message || e)); }
  };
    ...
    <div>
      ...
      <Wrap>
        ...
        {showNew && (<Card style={{ padding: 18 }}><SectionTitle>Open a motion</SectionTitle><div className="space-y-3">
          ...
          <div className="text-xs" style={{ color: T.textMuted }}>Every BCC member is alerted. The motion passes with a majority of all BCC members and executes automatically.</div>
    ...
    <div>
      ...
      <Wrap>
        ...
        {sel && (<>
          ...
          <Card style={{ padding: 16 }}>
            <SectionTitle>Activity trail</SectionTitle>
