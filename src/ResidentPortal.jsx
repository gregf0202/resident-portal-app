...
function Maintenance() {
  ...
  const raise = () => { if (!f.title.trim()) return; update((s) => s.maintenance.unshift({ id: "m" + Math.random().toString(36).slice(2, 6), buildingId, ...f, raisedBy: user.name, status: "new", triageOwner: "", date: today(), reportedAt: nowISO(), resolvedAt: "", statusHistory: [{ from: "", to: "new", by: user.name, at: nowISO() }], quotes: [], resolutions: [], updates: [] })); audit(buildingId, "maintenance.reported", f.title); setF({ title: "", category: MAINT_CATEGORIES[0], location: "", description: "", image: "" }); setRaising(false); flash("Issue logged · committee notified"); };
